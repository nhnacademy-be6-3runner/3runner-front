...
class CouponAnotherMessageListenerTest {
    ...
    @InjectMocks
    private CouponAnotherMessageListener couponAnotherMessageListener;
    ...
    void testReceiveMessage() {
        ...
        couponAnotherMessageListener.receiveMessage(couponFormDtos);
