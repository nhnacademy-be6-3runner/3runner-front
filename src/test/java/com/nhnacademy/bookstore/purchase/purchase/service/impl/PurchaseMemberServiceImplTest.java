...
//         when(purchaseRepository.save(any(Purchase.class))).thenReturn(purchase1);
//
//         Long purchaseId = purchaseMemberService.updatePurchase(UpdatePurchaseMemberRequest.builder().purchaseStatus(PurchaseStatus.SHIPPED.name()).build(),1L, purchase1.getId());
//
//         assertNotNull(purchaseId);
