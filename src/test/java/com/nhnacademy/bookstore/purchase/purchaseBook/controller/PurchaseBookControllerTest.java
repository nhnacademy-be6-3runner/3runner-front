...
//
//         // Mock service method
//         doNothing().when(purchaseBookService).deletePurchaseBook(any(Long.class));
//         BindingResult bindingResult = new MapBindingResult(new HashMap<>(), "deletePurchaseBookRequest");
//
//         // Call controller method
//         ApiResponse<Void> responseEntity = purchaseBookController.deletePurchaseBook(1L);
//
//         // Verify
//         assertEquals(204, responseEntity.getHeader().getResultCode());
//         assertTrue(responseEntity.getHeader().isSuccessful());
//         verify(purchaseBookService).deletePurchaseBook(1L);
//     }
//
//     @DisplayName("주문-책 수정")
//     @Test
