...
public class QPayment extends EntityPathBase<Payment> {
    ...
    public final NumberPath<Integer> tossAmount = createNumber("tossAmount", Integer.class);

    public final NumberPath<Integer> tossAmountTasFree = createNumber("tossAmountTasFree", Integer.class);

    public final StringPath tossOrderId = createString("tossOrderId");

    public final StringPath tossProductDesc = createString("tossProductDesc");
